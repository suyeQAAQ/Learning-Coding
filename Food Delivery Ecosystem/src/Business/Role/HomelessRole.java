...
import UserInterface.HomelessPeople.HomelessCardLoginJPanel;
...
public class HomelessRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise,Network city, Business business) {
        return new HomelessCardLoginJPanel(userProcessContainer,account,organization,enterprise,city);
    }
}
